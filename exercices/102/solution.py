# -*- coding: utf-8 -*-
"""
Created on Fri Sep 26 11:19:46 2014
...
def check_my_city(mycity):
    stations_nb = 0
    zip_code = []
    for station in velib:
        if station['city'].lower().rstrip("-") == mycity:
            print("yey")
            stations_nb += 1
            zip_code.append(station['zip'].rstrip("-"))
    if stations_nb == 0:
        return "Sorry! No station for your city has been found!"
    else:
        return {"stations_nb": stations_nb,
                "zip_code": zip_code,
                "city":  mycity
                }
